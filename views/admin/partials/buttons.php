<?php if (isset($buttons) && is_array($buttons)): ?>
	...
	<?php 
		...
		if(isset($button_type) && $button_type == 'primary'):
			$btn_class = 'md-raised btn-w-md md-button md-primary';
		elseif(isset($button_type) && $button_type == 'secondary'):
			$btn_class = 'md-raised btn-w-md md-button';
		else:
			// Default to primary
			$btn_class = 'btn btn-w-md ui-wave';
		endif;
	...
	<?php foreach ($buttons as $key => $button): ?>
		...
		<?php switch ($button) :
			...
			case 'upload': ?>
                ...
                <!--md-button class="md-raised btn-w-md md-primary"><?php echo lang('buttons:' . $button); ?></md-button-->
				<?php break;
			case 'cancel':
			case 'close':
			case 'preview':
				...
				echo anchor($uri, lang('buttons:' . $button), 'class="btn btn-default  ' . $btn_class . '"');
				break;
