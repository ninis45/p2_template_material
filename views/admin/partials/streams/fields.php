<?php if (!empty($fields)): ?>
    ...
    <table class="table-list table" border="0" cellspacing="0">
		<thead>
			<tr>
...
<?php else: ?>
	<div class="alert alert-info"><?php echo lang('streams:start.no_fields');?> <?php echo anchor(isset($add_uri) ? $add_uri : 'admin/streams/fields/add', lang('streams:start.add_one'), 'class="add"'); ?>.</div>
<?php endif;?>
